...
def show_webcam(mirror=False):
    ...
    while True:
        try:
            ...
            rate = shared["rate"]
            rot_speed = shared["rot_speed"]
            veh_speed = shared["veh_speed"]
            show_js = shared["show_js"]
            show_vehicle = shared["show_vehicle"]
            m0_rpm = shared["m0_rpm"]
...
##        cv2.putText(img,str(m0_rpm),(w-w*3/10,h-h/10), font, 1,(50,255,255),1,cv2.LINE_AA)
        ...
        cv2.putText(img,"Battery Voltage (1S):",(5,30), font, 0.5,(50,255,255),1,cv2.LINE_AA)
        batt = int(batt) / 100.0
        battery = str(batt) + "V"
        cv2.putText(img,battery,(180,30), font, 0.5,(50,255,255),1,cv2.LINE_AA)
        if show_js:
        ...
        if show_vehicle:
            ...
            #print rpm values
            cv2.putText(img,str(m1_rpm),(480,47), font, 0.5,(50,255,255),1,cv2.LINE_AA)
            cv2.putText(img,str(m2_rpm),(602,47), font, 0.5,(50,255,255),1,cv2.LINE_AA)
            cv2.putText(img,str(m0_rpm),(544,153), font, 0.5,(50,255,255),1,cv2.LINE_AA)
        
        #print parameters
        cv2.putText(img,"Rate: ",(500,200), font, 0.5, (50,255,255), 1 ,cv2.LINE_AA)
        cv2.putText(img,str(rate),(600,200), font, 0.5, (50,255,255), 1 ,cv2.LINE_AA)
        cv2.putText(img,"Rot. Speed: ",(500,250), font, 0.5, (50,255,255), 1 ,cv2.LINE_AA)
        cv2.putText(img,str(rot_speed),(600,250), font, 0.5, (50,255,255), 1 ,cv2.LINE_AA)
        cv2.putText(img,"Veh. Speed: ",(500,300), font, 0.5, (50,255,255), 1 ,cv2.LINE_AA)
        cv2.putText(img,str(veh_speed),(600,300), font, 0.5, (50,255,255), 1 ,cv2.LINE_AA)
        cv2.putText(img,"Show JS: ",(500,350), font, 0.5, (50,255,255), 1 ,cv2.LINE_AA)
        if show_js:
            js_txt = "ON"
        else:
            js_txt = "OFF"
        cv2.putText(img,str(js_txt),(600,350), font, 0.5, (50,255,255), 1 ,cv2.LINE_AA)
        cv2.putText(img,"Show Veh.: ",(500,400), font, 0.5, (50,255,255), 1 ,cv2.LINE_AA)
        if show_vehicle:
            vh_txt = "ON"
        else:
            vh_txt = "OFF"
        cv2.putText(img,str(vh_txt),(600,400), font, 0.5, (50,255,255), 1 ,cv2.LINE_AA)

        #draw rectangle to highlight current parameter
        rect_dist = 185 + current_state_index * 50
